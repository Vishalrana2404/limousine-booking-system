...
class AddBookingRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
        ...
        return [
            ...
            'pick_up_location' => (in_array($serviceTypeId, ["2", "3", "4", "5"]) || $pickupLocationId === "8") ? 'required|min:3' : 'nullable|min:3',
            'drop_of_location' => (in_array($serviceTypeId, ["1", "2", "5"]) || $dropLocationId === "8") ? 'required|min:3' : 'nullable|min:3',
