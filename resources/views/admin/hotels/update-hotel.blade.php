...
@section('content')
    <form id="hotelForm" method="post" action="{{ route('update-hotel', $hotel) }}">
        @csrf
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <h6 class="head-sm medium">Update Corporate</h6>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" id="updateHotelFormButton"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="status"
                                                    ...
                                                    <option value="ACTIVE"
                                                        {{ $hotel->status === 'ACTIVE' ? 'selected' : '' }}>Active</option>
                                                    <option value="INACTIVE"
                                                        {{ $hotel->status === 'INACTIVE' ? 'selected' : '' }}>Inactive
                                                    </option>
                                                </select>
                                                @error('status')
                                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="card-body px-0">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    @endif
                                    <div class="form-group row g-2">
                                        <label for="perTripDelivery" class="col-sm-4 col-form-label">Per Trip
                                            Delivery</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="perHourDelivery" class="col-sm-4 col-form-label">Per Hour Rates</label>
                                    </div>
                                    @if(!empty($vehicleClasses))
                                        @foreach($vehicleClasses as $vehicleClass)
                                            <div class="form-group row g-2 mx-4">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="text" id="perHourDelivery_{{ $vehicleClass->id }}" name="per_hour_rate_{{ $vehicleClass->id }}"
                                                        ...
                                                        placeholder="{{ $vehicleClass->name }} Rates" autocomplete="off">
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierMidnightSurchargeLessThen23Seats"
                                            class="col-sm-4 col-form-label">Midnight surcharge (< 23s)</label>
                                                <div class="col-sm-3">
                                                    <select name="fixed_multiplier_midnight_surcharge_greater_then_23_seats"
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierArrivelWaitingTime"
                                            class="col-sm-4 col-form-label">Arrival waiting time</br>(60 minutes
                                            grace)</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierDepatureAndTransferWaiting"
                                            class="col-sm-4 col-form-label">Departure and transfer waiting </br>(30 minutes
                                            grace)</label>
                                        <div class="col-sm-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierOutsideCitySurchargeLessThen23Seats"
                                            class="col-sm-4 col-form-label">Outside city surcharge(< 23s)</label>
                                                <div class="col-sm-3">
                                                    <select
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierAdditionalStop"
                                    ...
                                    <div class="form-group row g-2">
                                        <label for="fixedMultiplierMiscCharges" class="col-sm-4 col-form-label">Misc
                                            charges</label>
                                        <div class="col-sm-3">
