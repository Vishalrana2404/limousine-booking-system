...
@section('content')
<form id="createClientForm" method="post" action="{{ route('client-save') }}">
    @csrf
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <h6 class="head-sm medium">Add Clients</h6>
                    </div>
                    <div class="col-md-4">
                        <button type="submit" id="addClientFormButton" class="float-right btn btn-outline-primary mx-2" title="Save">Save</button>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="firstName" name="first_name" value="{{ old('first_name') }}" class="form-control @error('first_name') is-invalid @enderror" placeholder="First name" autocomplete="off" autofocus>
                                @error('first_name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="lastname" name="last_name" value="{{ old('last_name') }}" class="form-control @error('last_name') is-invalid @enderror" placeholder="Last name" autocomplete="off">
                                @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="client_type" id="clientType" class="form-control form-select custom-select @error('client_type') is-invalid @enderror" autocomplete="off">
                                    ...
                                    @if (old('client_type') === $userType->id)
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="Email" autocomplete="off">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" placeholder="Contact" autocomplete="off">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="invoice" name="invoice" value="{{ old('invoice') }}" class="form-control @error('invoice') is-invalid @enderror" placeholder="Invoice" autocomplete="off">
                                @error('invoice')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
